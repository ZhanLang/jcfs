...
应用程序向导已为您创建了此 JCSrv 项目，作为编写服务 (EXE) 的起点。
...
JCSrv.h
    此文件包含 JCSrv.idl 中定义的项目的 C++ 接口定义
...
StdAfx.h，StdAfx.cpp
    这些文件用于生成名为 JCSrv.pch 的预编译头 (PCH) 文件和
...
JCSrvps.vcxproj
    ...
    文件。此进程生成 dlldata.c、JCSrv_i.c 和 
    JCSrv_p.c，这些文件是生成代理/存根 (stub) DLL 所必需的。

JCSrvps.vcxproj.filters
